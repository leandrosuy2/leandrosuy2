...
> Sempre em busca de novos desafios — adapto-me rápido a novas stacks e priorizo entregar soluções robustas e fáceis de manter.
...
### Práticas
`SOLID` · `Clean Architecture` · `Design Patterns` · `Scrum` · `Kanban`
...
| --- | --- | --- |
| [PhishGuard](https://github.com/leandrosuy2/PhishGuard) | Ferramenta voltada à detecção / prevenção de phishing | JavaScript |
| [controle-financeiro](https://github.com/leandrosuy2/controle-financeiro) | Sistema de controle financeiro | TypeScript |
| [bot-cobrancas](https://github.com/leandrosuy2/bot-cobrancas) | Bot de cobranças automatizadas | TypeScript |
| [ponto-eletronico-api](https://github.com/leandrosuy2/ponto-eletronico-api) | API de ponto eletrônico | TypeScript |
| [gestao-hospitalar](https://github.com/leandrosuy2/gestao-hospitalar) | Sistema de gestão hospitalar | TypeScript |
| [inventory-system-spring](https://github.com/leandrosuy2/inventory-system-spring) | Gestão de inventário | Java / Spring |
| [nestjs-cep-api](https://github.com/leandrosuy2/nestjs-cep-api) | API de consulta de CEP com NestJS | NestJS |
...
- 💼 [LinkedIn](https://www.linkedin.com/in/leandro-dantas-1959b711b/)
- 📸 [Instagram](https://www.instagram.com/_su7)
- ✉️ [leandrosuy@gmail.com](mailto:leandrosuy@gmail.com)
- 👨‍💻 [github.com/leandrosuy2](https://github.com/leandrosuy2)

<details>
<summary>📌 Perfil anterior</summary>

Este é o meu perfil atual no GitHub. O perfil antigo ainda está disponível em: [github.com/leandrosuy](https://github.com/leandrosuy)
...
⭐ Obrigado por visitar! Se curtir algum projeto, deixa uma estrela.
